package com.example.casa.apprestaurant.dbmodelo;
...
public class BDhelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        sqLiteDatabase.execSQL("create table platos(id integer primary key autoincrement,resumen text,precio integer, foto text )");
